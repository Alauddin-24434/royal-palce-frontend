...
const HeroDateRange = () => {
  ...
  const handleCheckAvailability = async () => {
    try {
      ...
      const response = await fetch('https://royal-place-server.vercel.app/api/rooms-available', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className="flex items-center justify-center min-h-[400px] w-full px-4">
      <div className="bg-white/10 backdrop-blur-md border border-white/30 rounded-xl p-6 shadow-lg w-full max-w-4xl space-y-6">
        <h2 className="text-2xl font-semibold text-white text-center">Select Your Stay Dates</h2>
