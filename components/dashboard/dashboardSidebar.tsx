...
const adminMenuItems = [
  ...
  { title: "Payments Management", url: "/dashboard/admin/payments", icon: CreditCard },
  { title: "Rooms Management", url: "/dashboard/admin/rooms", icon: Bed },
  { title: "Bookings Management", url: "/dashboard/admin/bookings", icon: Calendar },
  { title: "Users Management", url: "/dashboard/admin/users", icon: Users },
  { title: "Service Management", url: "/dashboard/admin/services", icon: Building },
];

const receptionistMenuItems = [
  { title: "Dashboard", url: "/dashboard/receptionist", icon: Crown },
  { title: "Payments Management", url: "/dashboard/receptionist/payments", icon: CreditCard },
  { title: "Bookings Management", url: "/dashboard/receptionist/bookings", icon: Calendar },
  { title: "Check-In", url: "/dashboard/receptionist/checkin", icon: Users },
  { title: "Reservations", url: "/dashboard/receptionist/reservations", icon: Calendar },
];
    ...
    <Sidebar className="border-r bg-main">
      <SidebarHeader className="border-b p-4">
        <Link href="/" className="flex items-center space-x-2">
          ...
          <span className="text-2xl font-bold text-yellow-500">ROYAL PALACE</span>
        </Link>
      </SidebarHeader>
