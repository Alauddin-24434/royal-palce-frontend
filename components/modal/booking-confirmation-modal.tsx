...
export default function BookingConfirmationModal({ isOpen, onClose, bookingDetails }: BookingConfirmationModalProps) {
  ...
  const handleConfirmBooking = async () => {
    ...
    try {
      const response = await fetch("https://royal-place-server.vercel.app/api/bookings", {
        method: "POST",
        headers: {
      ...
      <DialogContent className="bg-slate-800 border-slate-700 text-white max-w-md">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Label className="text-slate-200">Special Requests (Optional)</Label>
              <textarea
          ...
          <div className="flex gap-3">
            ...
            <Button
              ...
              disabled={isSubmitting || !guestInfo.name || !guestInfo.email || !guestInfo.phone}
